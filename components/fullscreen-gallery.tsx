		...
		>
			<div className="text-center text-white">
				<div className="mb-8">
					...
					<h2 className="text-2xl font-serif mb-2">GOODCLUB</h2>
					<p className="text-sm opacity-80">Loading 3D Gallery...</p>
				</div>
...
export default function FullscreenGallery({
	...
	return (
		<>
			{!showGallery && <Preloader onComplete={handlePreloaderComplete} />}
			<div 
				className={`${className} transition-opacity duration-500 ${showGallery ? 'opacity-100' : 'opacity-0'}`}
				style={{ 
					...style, 
